...
public class Main {
    ...
    public static final Card[] STARTER_CARDS = new Card[] // check is this belongs in the UML and how to implement it
    {
    ...
    public static ArrayList<Card> getStarterDeck() //check UML
    {

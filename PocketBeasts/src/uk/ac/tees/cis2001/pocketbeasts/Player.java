...
public class Player {
    ...
    private final Deck deck; //check to see if this needs to be in the UML
    private final Hand hand; //check to see if this needs to be in the UML
    private final InPlay inPlay; //check to see if this needs to be in the UML
    private final Graveyard graveyard; //check to see if this needs to be in the UML

    public Player(String name, Deck deck) // check UML
        {
        this.name = name;
    ...
    public Deck getDeck()// Check UML
    {
        return this.deck;
    }
    
    public Hand getHand()// Check UML
    {
        return this.hand;
    }

    public InPlay getInPlay()// Check UML 
    {
        return this.inPlay;
    }
    
    public Graveyard getGraveyard()// Check UML 
    {
